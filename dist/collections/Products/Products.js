...
var syncUser = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var fullUser, products, productArray, allIDs_1, createdProductIDs, dataToUpdate;
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                productArray = Array.isArray(products) ? products : [];
                allIDs_1 = __spreadArray([], (productArray.map(function (product) {
    ...
    hooks: {
        ...
        beforeChange: [
            ...
            function (args) { return __awaiter(void 0, void 0, void 0, function () {
                var data, updatedProduct, createdProduct, updated_1, updated;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            data = args.data;
                            if (!(args.operation === 'create')) return [3 /*break*/, 2];
                            return [4 /*yield*/, paystack_1.paystack.post('/product', {
                                    name: data.name,
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, paystack_1.paystack.put("/product/".concat(data.paystackProductId), {
                                    name: data.name,
                                    price: Math.round(data.price * 100),
                                    currency: 'USD',
                                }).then(function (res) { return res.data; })];
                        case 3:
                            updated_1 = _a.sent();
                            updatedProduct = updated_1;
                            _a.label = 4;
                        case 4:
                            updated = __assign(__assign({}, data), { paystackProductId: updatedProduct.id });
